    ...
    <div className="bg-[#011450] min-h-screen flex justify-center items-center relative">
      <div className="absolute top-[5px]">
        <img
          src={logo}
          alt="logo"
          className="h-[240px] w-[240px] object-contain mx-auto"
        />
      </div>
      <div className="bg-white w-[35%] px-[60px] rounded-[6px] pt-42 pb-[20px]">
        <h1 className="font-bold text-3xl text-center font-serif">
          Log in to <span className="text-[#041150]">Doctor Ji</span>
        </h1>
        ...
        <p className="text-gray-500 text-[13px] mt-[16px] "> Password</p>
        <Box className=" mt-[8px]">
          <TextField
            id="outlined-basic"
            size="small"
